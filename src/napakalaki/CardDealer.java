...
public class CardDealer {
    ...
    private void initMonsterCardDeck(){
        ...
        SpecificBC badByakhees = new SpecificBC("Pierdes tu armadura "
        ...
        //Chibithulhu
        SpecificBC badChibithulhu = new SpecificBC("Embobados con el "
        ...
        //El sopor de Dunwich
        SpecificBC badDunwich = new SpecificBC("El primordial bostezo "
        ...
        SpecificBC badAngelesIbicencos = new SpecificBC("Te atrapan para"
        ...
        NumericBC badGorronUmbral = new NumericBC("Pierdes todos tus "
        ...
        //H.P Munchcraft
        SpecificBC badHP = new SpecificBC("Pierdes la armadura visible",
        ...
        //Bichgooth
        SpecificBC badBichgooth = new SpecificBC("Sientes bichos bajo la "
        ...
        //El rey de rosa
        NumericBC badReyRosa = new NumericBC("Pierdes 5 niveles y 3 "
                + "tesoros visibles",
        5,3,0);
        ...
        NumericBC badTinieblas = new NumericBC("Toses los pulmones y"
        ...
        // Semillas Cthulhu
        NumericBC badSemillasCthulhu = new NumericBC("Pierdes 2 niveles y 2"
        ...
        // Dameargo
        SpecificBC badDameargo = new SpecificBC("Te intentas escaquear. Pierdes"
        ...
        // Pollipólipo volante
        NumericBC badPollipolipo = new NumericBC("Da mucho asquito. Pierdes"
                + " 3 niveles",3,0,0);
        ...
        // Yskhtihyssq-Goth
        DeathBC badYskhtihyssq = new DeathBC("No le hace gracia que"
        ...
        // Familia Feliz
        DeathBC badFamiliaFeliz = new DeathBC("La familia te atrapa. Estas"
                + " muerto");
        Prize prizeFamiliaFeliz = new Prize(4,1);
        unusedMonsters.add(new Monster("Familia feliz",1,badFamiliaFeliz,prizeFamiliaFeliz));
        
        // Roboggoth
        SpecificBC badRoboggoth = new SpecificBC("La quinta directiva primaria te"
        ...
        // El espía
        SpecificBC badEspia = new SpecificBC("Te asusta en la noche."
        ...
        //El Lenguas
        NumericBC badLenguas = new NumericBC("Menudo susto te llevas. "
                + "Pierdes 2 niveles y 5 tesoros visibles",2,5,0);
        Prize prizeLenguas = new Prize(1,1);
        unusedMonsters.add(new Monster("El Lenguas",20,badLenguas,prizeLenguas));
        
        //Bicéfalo
        SpecificBC badBicefalo = new SpecificBC("Te faltan manos para "
        ...
        SpecificBC badIndecible = new SpecificBC("Pierdes 1 "
        ...
        //Testigos oculares
        NumericBC badTestigos = new NumericBC("Pierdes tus "
        ...
        //Shoggoth
        NumericBC badShoggoth = new NumericBC("Pierdes 2 niveles",2,0,0);
        Prize prizeShoggoth = new Prize(4,2);
        unusedMonsters.add(new Monster("Shoggoth",16,badShoggoth,prizeShoggoth,-4));
        
        //Lolitagooth
        NumericBC badLolitagooth = new NumericBC("Pintalabios negro. Pierdes 2 niveles",2,0,0);
