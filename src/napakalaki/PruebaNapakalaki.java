...
//                if(mons.getBadConsequence().getNHiddenTreasures() == 0){
//                    if(mons.getBadConsequence().getNVisibleTreasures() == 0){
//                        if(mons.getBadConsequence().getSpecificHiddentreasures().isEmpty()){
//                            if(mons.getBadConsequence().getSpecificVisibletreasures().isEmpty()){
//                                System.out.println(mons.toString());
